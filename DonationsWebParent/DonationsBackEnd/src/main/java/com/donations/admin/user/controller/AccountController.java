...
public class AccountController {
	...
	public String saveAccountDetails(User user, RedirectAttributes redirectAttributes, 
		...
		loggedUserDetails.setFirstName(user.getFirstName());
		loggedUserDetails.setLastName(user.getLastName());
